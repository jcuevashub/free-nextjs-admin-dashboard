...
export default function UserDropdown({ userName, userEmail }: UserDropdownProps) {
  const { userEmail: sessionEmail, userName: sessionName } = useSession();
  const [isOpen, setIsOpen] = useState(false);

  const emailState = userEmail ?? sessionEmail;
  const nameState = userName ?? sessionName;
